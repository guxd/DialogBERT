...
class HBertMseEuopDataset(DialogTransformerDataset):
    ...
    adopted: https://github.com/codertimo/BERT-pytorch/blob/master/bert_pytorch/dataset/dataset.py
    https://oss.navercorp.com/ClovaAI-PJT/BERT/blob/master/create_pretraining_data.py
    """
    def __init__(self, file_path, tokenizer,
